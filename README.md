...
- Free 2-step registration (modal + inline): **Details → Join WhatsApp community**
- **Lead capture** on every registration - to a Google Sheet (Apps Script webhook) and Privyr CRM
...
export const LEAD_WEBHOOK_URL = 'https://script.google.com/macros/s/.../exec' // Google Sheet, optional
export const PRIVYR_WEBHOOK_URL = 'https://www.privyr.com/api/v1/incoming-leads/.../...' // Privyr CRM, optional
```
